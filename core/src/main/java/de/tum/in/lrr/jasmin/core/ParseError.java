...
public class ParseError {
    ...
    /**
     * @param line                the original whole line containing the error
     * @param errorString         the error itself
     * @param searchStartPosition where the error occured in that line
     * @param errorMessage        the message to give to the user
     */
    ...
    /**
     * @param line            the original whole line containing the error
     * @param invalidArgument the argument that is faulty
     * @param errorMsg        the message to give to the user
     */
