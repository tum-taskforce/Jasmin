...
public class Memory implements Serializable {
     ...
     *
     * @param size       the amount of cells you want to be created
     * @param startIndex the index/address of the first cell
     */
    ...
    /**
     * @param value value to be set to sets the value
     */
