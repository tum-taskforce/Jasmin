...
public abstract class JasminCommand {
     ...
     *
     * @param mnemo the mnemo of the command whose default operation size is to be returned
     ...
     *
     * @param word     the number/bitstring
     * @param position the number of the bit of interest, counted from the right starting with 0
     ...
     *
     * @param word     the number/bitstring
     * @param flag     the desired value of the bit
     * @param position the number of the bit of interest
     ...
     *
     * @param mnemo the mnemo of the command in question
     */
     ...
     *
     * @param p     the command's Parameters object
     ...
     *
     * @param cc the postfix for the condition
