...
public class CommandLoader {
    ...
    /**
     * @param newdataspace   which dataspace the commandloader is linked to
     * @param defaultpackage the package all the commands are in
     * @param type           the super class of the commands
     */
     ...
     *
     * @param file location where the .class files containing the command are
     ...
     *
     * @param file  directory to load from
