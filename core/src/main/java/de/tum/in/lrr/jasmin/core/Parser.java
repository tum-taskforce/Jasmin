...
public class Parser {
     ...
     *
     * @param cacheSize the desired size of the cache, i.e. the number of lines that are about to be cached
     */
     ...
     *
     * @param s             the string with the numbers in it
     * @param numberPattern the regex-pattern of the affected numbers
     * @param base          the number system's base of the affected numbers
     * @param skipFirst     the number of bytes at the beginning of the pattern that should be skipped when converting
     *                      because they
     *                      are a prefix
     * @param skipLast      the number of bytes at the end of the pattern that should be skipped when converting because
     *                      they are a
     *                      suffix
     ...
     *
     * @param s the string that may contain a comment
     ...
     *
     * @param s the string that is to be examined
     ...
     *
     * @param s the String that may contain a label
     ...
     *
     * @param operand     the operand that the information is about
     * @param unsizedType the type of the operand (without size information)
     ...
     *
     * @param operand    the operand that is to be examined
     * @param executeNow pass true here if the line containing the operand is just about to be executed. This affects the
     ...
     *
     * @param s          the memory address to be validated
     * @param size       the number of bytes that are to be written/read
     * @param executeNow pass true here if the line containing the operand is just about to be executed. If false is
     ...
     *
     * @param chars the String that is to be converted
     ...
     * constants
     *
     * @param a the native size of the String / operation
     ...
     *
     * @param line the String with the comment in it
