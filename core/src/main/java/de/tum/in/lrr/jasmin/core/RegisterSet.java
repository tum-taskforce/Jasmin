...
public class RegisterSet {
     ...
     *
     * @param argL argument (address) for the lowest byte
     * @param argH argument (address) for the second lowest byte
     * @param argX argument (address) for the lower word
     * @param argE argument (address) for the double word
     * @param strL name for the lowest byte
     * @param strH name for the second lowest byte
     * @param strX name for the lower word
     * @param strE name for the double word
     */
