...
public class CalculatedAddress {
    ...
    /**
     * @param dataspace the DataSpace that the CalculatedAddress is to be associated with
     */
    ...
    /**
     * @param size       compute validity of the address assuming this is the size of the access
     * @param executeNow pass true here if the access will occur right now. Passing false will disable parts of the error
     *                   checking
     ...
     *
     * @param executeNow you will most probably want to pass true here. Passing false is only usefull for validity
     *                   checking.
     ...
     *
     * @param s the String containing a representation of the address
