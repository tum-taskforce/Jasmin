...
public class DataSpace {
    ...
    /**
     * @param size 1, 2 or 4 depending on the mode of the memory table
     ...
     * interpreter
     *
     * @param ip the new value of the instruction pointer
     */
     ...
     * default constructor
     *
     * @param size         defines the size of the simulated memory
     * @param startAddress the address of the first byte of the simulated memory
     */
     ...
     * initiate memory
     *
     * @param size         which size the memory array has. The smallest multiple of 4 greater than size will be taken
     * @param startAddress the address of the first byte of memory
     */
     ...
     *
     * @param oos the object stream to save to
     * @throws IOException
     */
     ...
     *
     * @param ois the object stream to load from
     * @throws IOException
     ...
     *
     * @param value
     * @param address where to store. could be both register or memory
     * @see Address
     */
     ...
     *
     * @param numberString the String to interpret from
     * @param address      the location to store to. Could be both register or memory
     * @param type         BIN or HEX
     */
     ...
     *
     * @param address the address of the (first) memory cell to retrieve
     * @param size    the number of memory cells to retrieve
     ...
     * Java is used
     *
     * @param address the Address object specifying the desired register
     * @return a long value from the specified location
     */
     ...
     * @param type  BIN, HEX, SIGNED or UNSIGNED
     ...
     *
     * @param address the argument addressing the register or memory location
     */
    ...
    /**
     * @param a     which register/memory address to be traced
     * @param steps how many steps to be traced
     ...
     *
     * @param s the String representation of the register
    ...
    /**
     * @param a an Argument referring to a register or memory cell about which information is to be retrieved
    ...
    /**
     * @param register the register mnemonic as a String
     ...
     * @param a           an argument describing the register/memory address where the value is to be stored
     * @param memCellInfo the MemCellInfo object that is to be stored. Pass null if none is needed. general purpose method
     *                    to store
     *                    a value
     */
     ...
     *
     * @param a      the argument specifying the register/memory location whose value is to be read
     * @param signed true if the value is to be interpreted as a signed number
     ...
     *
     * @param a      the argument whose value is to be returned
     * @param signed signed access?
     ...
     *
     * @param size    the size of the required memory block
     * @param howmany the number of blocks
     ...
     *
     * @param label the label that is to be registered
     */
     ...
     *
     * @param label the variable that is to be unregistered
     */
     ...
     *
     * @param symbol the String that is to be checked
